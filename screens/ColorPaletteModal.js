...
import { View, Text, TextInput, StyleSheet, Switch, FlatList, TouchableOpacity, Alert } from 'react-native';
      ...
      const handleSubmit = useCallback(() => {
        if (!newPaletteName) {
          ...
          navigation.navigate('Home', {
            newPalette: { paletteName: newPaletteName, colors: selectedColors },
          });
        }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.heading}>
        ...
        <TextInput style={styles.input} value={newPaletteName} onChangeText={setNewPaletteName} />
      </View>
      <FlatList
        style={styles.list}
        data={COLORS}
